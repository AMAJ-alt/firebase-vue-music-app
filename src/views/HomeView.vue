  ...
  <main>
    ...
    <section class="container mx-auto">
      <div class="bg-white rounded border border-gray-200 relative flex flex-col">
        ...
        v-icon-secondery="{ icon: 'headphones-alt', right: true,}">
...
import IconSecondery from '@/directives/icon-secondery';
  ...
  methods: {
    ...
    async getSongs() {
      ...
      if (this.songs.length) {
        ...
        sanpshot = await songsCollection
