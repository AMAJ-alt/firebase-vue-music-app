<template>
  <main>
    ...
    <!-- Form -->
    <section id="comments" class="container mx-auto mt-6" v-if="userLoggedIn">
      <div class="bg-white rounded border border-gray-200 relative flex flex-col">
        ...
        <div class="p-6">
          <div class="text-white text-center font-bold p-4 mb-4" v-if="comment_show_alert" :class="comment_alert_varient">
            {{ comment_alert_message }}
          </div>
          <vee-form :validation-schema="schema" @submit="addComment">
            <label class="hidden">hey</label>
            ...
            <ErrorMessage class="text-red-600" name="comment" /><br>
            <button :disabled="comment_in_submition" type="submit"
...
<script>
import { songsCollection, auth, commentCollection } from '@/includes/firebase';
...
export default {
  ...
  data() {
    return {
      ...
      comment_alert_message: 'please wait! your message is being sdubmitted.',
  ...
  methods: {
    ...
    async addComment(values, { resetForm }) {
      ...
      this.comment_alert_message = 'please wait! your message is being sdubmitted.';
      ...
      try {
        ...
        this.comment_alert_message = 'something happend!';
        console.log(error);
      }
    ...
    async getComments() {
      const snapshot = await commentCollection.where('sid', '==', this.$route.params.id).get();
