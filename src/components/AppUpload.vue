  ...
  <div class="bg-white rounded border border-gray-200 relative flex flex-col">
    ...
    <div class="p-6">
      ...
      <div class="w-full px-10 py-20 rounded text-center cursor-pointer border border-dashed
        ...
        :class="{ 'bg-green-400 border-green-400 border-solid text-white': is_dragover }" @drag.prevent.stop=""
      ...
      <div class="mb-4" v-for="upload in uploads" :key="upload.name">
        ...
        <div class="flex h-4 overflow-hidden bg-gray-200 rounded">
          <!-- Inner Progress Bar -->
          <div class="transition-all progress-bar bg-blue-400" :class="upload.varient"
  ...
  methods: {
    upload($event) {
      ...
      files.forEach((file) => {
        ...
        const storageRef = storage.ref(); // music-7f6aa.appspot.com
        const songRefrence = storageRef.child(`songs/${file.name}`); // music-7f6aa.appspot.com/songs/example.mp3
        const task = songRefrence.put(file);
