<template>
  <!-- Auth Modal -->
  <div class="fixed z-10 inset-0 overflow-y-auto" id="modal" :class="{ hidden: !appAuthShow }">
...
export default {
  ...
  computed: {
    ...
    // }),
    ...mapState({
      appAuthShow: (state) => state.auth.appAuthShow,
    }),
    // appAuthShow() {
    //   return this.$store.getters.appAuthShow;
    // },
  },
  methods: {
