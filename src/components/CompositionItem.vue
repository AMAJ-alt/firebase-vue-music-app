<template>
  ...
  <div class="border border-gray-200 p-3 mb-4 rounded">
    <div v-show="!showForm">
      <h5 class="inline-block font-bold">{{ song.modified_name }}</h5>
    ...
    <div v-show="showForm">
      <div class="text-white text-center font-bold p-4 mb-4" v-if="show_alert" :class="alert_varient">{{ alert_message }}
      </div>
      <vee-form :validation-schema="schema" :initial-values="song" @submit="edit">
        <div class="mb-3">
          <label class="inline-block mb-2">Song Title</label>
          <vee-field name="modified_name" type="text" class="block w-full py-1.5 px-3 text-gray-800 border border-gray-300
        ...
        <div class="mb-3">
          ...
          <vee-field name="genre" type="text" class="block w-full py-1.5 px-3 text-gray-800 border border-gray-300
                        transition duration-500 focus:outline-none focus:border-black rounded"
  ...
  methods: {
    async edit(values) {
      ...
      try {
        ...
        this.alert_message = 'something happend !';
        console.log(error);
        return;
      }
